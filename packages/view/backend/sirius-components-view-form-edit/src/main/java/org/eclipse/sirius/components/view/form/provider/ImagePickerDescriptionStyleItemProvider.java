...
/**
 * This is the item provider adapter for a {@link org.eclipse.sirius.components.view.form.ImagePickerDescriptionStyle}
 * object. <!-- begin-user-doc --> <!-- end-user-doc -->
 *
 * @generated
 */
public class ImagePickerDescriptionStyleItemProvider extends WidgetDescriptionStyleItemProvider {
    /**
     * This constructs an instance from a factory and a notifier. <!-- begin-user-doc --> <!-- end-user-doc -->
     *
     * @generated
     */
    public ImagePickerDescriptionStyleItemProvider(AdapterFactory adapterFactory) {
    ...
    /**
     * This returns ImagePickerDescriptionStyle.gif. <!-- begin-user-doc --> <!-- end-user-doc -->
     *
     * @generated
     */
    @Override
    public Object getImage(Object object) {
        return this.overlayImage(object, this.getResourceLocator().getImage("full/obj16/ImagePickerDescriptionStyle"));
    }
    ...
    public String getText(Object object) {
        ImagePickerDescriptionStyle imagePickerDescriptionStyle = (ImagePickerDescriptionStyle) object;
        return this.getString("_UI_ImagePickerDescriptionStyle_type") + " " + imagePickerDescriptionStyle.getFontSize();
    }
    ...
    public void notifyChanged(Notification notification) {
        ...
        switch (notification.getFeatureID(ImagePickerDescriptionStyle.class)) {
