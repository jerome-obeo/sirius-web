...
/**
 * <!-- begin-user-doc --> An implementation of the model object '<em><b>Conditional Image Picker Description
 * Style</b></em>'. <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 * <li>{@link org.eclipse.sirius.components.view.form.impl.ConditionalImagePickerDescriptionStyleImpl#getFontSize
 * <em>Font Size</em>}</li>
 * <li>{@link org.eclipse.sirius.components.view.form.impl.ConditionalImagePickerDescriptionStyleImpl#isItalic
 * <em>Italic</em>}</li>
 * <li>{@link org.eclipse.sirius.components.view.form.impl.ConditionalImagePickerDescriptionStyleImpl#isBold
 * <em>Bold</em>}</li>
 * <li>{@link org.eclipse.sirius.components.view.form.impl.ConditionalImagePickerDescriptionStyleImpl#isUnderline
 * <em>Underline</em>}</li>
 * <li>{@link org.eclipse.sirius.components.view.form.impl.ConditionalImagePickerDescriptionStyleImpl#isStrikeThrough
 * <em>Strike Through</em>}</li>
 * <li>{@link org.eclipse.sirius.components.view.form.impl.ConditionalImagePickerDescriptionStyleImpl#getColor
 * <em>Color</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ConditionalImagePickerDescriptionStyleImpl extends ConditionalImpl implements ConditionalImagePickerDescriptionStyle {
    /**
     ...
     * @generated
     */
    protected ConditionalImagePickerDescriptionStyleImpl() {
        super();
    }
    ...
    protected EClass eStaticClass() {
        return FormPackage.Literals.CONDITIONAL_IMAGE_PICKER_DESCRIPTION_STYLE;
    }
    ...
    public void setFontSize(int newFontSize) {
        ...
        if (this.eNotificationRequired())
            this.eNotify(new ENotificationImpl(this, Notification.SET, FormPackage.CONDITIONAL_IMAGE_PICKER_DESCRIPTION_STYLE__FONT_SIZE, oldFontSize, this.fontSize));
    }
    ...
    public void setItalic(boolean newItalic) {
        ...
        if (this.eNotificationRequired())
            this.eNotify(new ENotificationImpl(this, Notification.SET, FormPackage.CONDITIONAL_IMAGE_PICKER_DESCRIPTION_STYLE__ITALIC, oldItalic, this.italic));
    }
    ...
    public void setBold(boolean newBold) {
        ...
        this.bold = newBold;
        if (this.eNotificationRequired())
            this.eNotify(new ENotificationImpl(this, Notification.SET, FormPackage.CONDITIONAL_IMAGE_PICKER_DESCRIPTION_STYLE__BOLD, oldBold, this.bold));
    }
    ...
    public void setUnderline(boolean newUnderline) {
        ...
        if (this.eNotificationRequired())
            this.eNotify(new ENotificationImpl(this, Notification.SET, FormPackage.CONDITIONAL_IMAGE_PICKER_DESCRIPTION_STYLE__UNDERLINE, oldUnderline, this.underline));
    }
    ...
    public void setStrikeThrough(boolean newStrikeThrough) {
        ...
        if (this.eNotificationRequired())
            this.eNotify(new ENotificationImpl(this, Notification.SET, FormPackage.CONDITIONAL_IMAGE_PICKER_DESCRIPTION_STYLE__STRIKE_THROUGH, oldStrikeThrough, this.strikeThrough));
    }
    ...
    public UserColor getColor() {
        if (this.color != null && this.color.eIsProxy()) {
            ...
            if (this.color != oldColor) {
                if (this.eNotificationRequired())
                    this.eNotify(new ENotificationImpl(this, Notification.RESOLVE, FormPackage.CONDITIONAL_IMAGE_PICKER_DESCRIPTION_STYLE__COLOR, oldColor, this.color));
            }
        }
        return this.color;
    }
    ...
    public void setColor(UserColor newColor) {
        ...
        this.color = newColor;
        if (this.eNotificationRequired())
            this.eNotify(new ENotificationImpl(this, Notification.SET, FormPackage.CONDITIONAL_IMAGE_PICKER_DESCRIPTION_STYLE__COLOR, oldColor, this.color));
    }
    ...
    public Object eGet(int featureID, boolean resolve, boolean coreType) {
        switch (featureID) {
            ...
            case FormPackage.CONDITIONAL_IMAGE_PICKER_DESCRIPTION_STYLE__COLOR:
                if (resolve)
    ...
    public int eBaseStructuralFeatureID(int derivedFeatureID, Class<?> baseClass) {
        ...
        if (baseClass == ImagePickerDescriptionStyle.class) {
            switch (derivedFeatureID) {
                case FormPackage.CONDITIONAL_IMAGE_PICKER_DESCRIPTION_STYLE__COLOR:
                    return FormPackage.IMAGE_PICKER_DESCRIPTION_STYLE__COLOR;
                default:
                    return -1;
            }
        }
    ...
    public int eDerivedStructuralFeatureID(int baseFeatureID, Class<?> baseClass) {
        ...
        if (baseClass == LabelStyle.class) {
            switch (baseFeatureID) {
                case ViewPackage.LABEL_STYLE__FONT_SIZE:
                    return FormPackage.CONDITIONAL_IMAGE_PICKER_DESCRIPTION_STYLE__FONT_SIZE;
                case ViewPackage.LABEL_STYLE__ITALIC:
                    return FormPackage.CONDITIONAL_IMAGE_PICKER_DESCRIPTION_STYLE__ITALIC;
                case ViewPackage.LABEL_STYLE__BOLD:
                    return FormPackage.CONDITIONAL_IMAGE_PICKER_DESCRIPTION_STYLE__BOLD;
                case ViewPackage.LABEL_STYLE__UNDERLINE:
                    return FormPackage.CONDITIONAL_IMAGE_PICKER_DESCRIPTION_STYLE__UNDERLINE;
                case ViewPackage.LABEL_STYLE__STRIKE_THROUGH:
                    return FormPackage.CONDITIONAL_IMAGE_PICKER_DESCRIPTION_STYLE__STRIKE_THROUGH;
                default:
                    return -1;
            }
        }
        if (baseClass == ImagePickerDescriptionStyle.class) {
            switch (baseFeatureID) {
                case FormPackage.IMAGE_PICKER_DESCRIPTION_STYLE__COLOR:
                    return FormPackage.CONDITIONAL_IMAGE_PICKER_DESCRIPTION_STYLE__COLOR;
                default:
                    return -1;
            }
        }
...
} // ConditionalImagePickerDescriptionStyleImpl
