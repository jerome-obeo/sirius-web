...
/**
 * <!-- begin-user-doc --> An implementation of the model object '<em><b>Image Picker Description Style</b></em>'. <!--
 * end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 * <li>{@link org.eclipse.sirius.components.view.form.impl.ImagePickerDescriptionStyleImpl#getFontSize <em>Font
 * Size</em>}</li>
 * <li>{@link org.eclipse.sirius.components.view.form.impl.ImagePickerDescriptionStyleImpl#isItalic
 * <em>Italic</em>}</li>
 * <li>{@link org.eclipse.sirius.components.view.form.impl.ImagePickerDescriptionStyleImpl#isBold <em>Bold</em>}</li>
 * <li>{@link org.eclipse.sirius.components.view.form.impl.ImagePickerDescriptionStyleImpl#isUnderline
 * <em>Underline</em>}</li>
 * <li>{@link org.eclipse.sirius.components.view.form.impl.ImagePickerDescriptionStyleImpl#isStrikeThrough <em>Strike
 * Through</em>}</li>
 * <li>{@link org.eclipse.sirius.components.view.form.impl.ImagePickerDescriptionStyleImpl#getColor <em>Color</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ImagePickerDescriptionStyleImpl extends WidgetDescriptionStyleImpl implements ImagePickerDescriptionStyle {
    /**
     ...
     * @generated
     */
    protected ImagePickerDescriptionStyleImpl() {
        super();
    }
    ...
    protected EClass eStaticClass() {
        return FormPackage.Literals.IMAGE_PICKER_DESCRIPTION_STYLE;
    }
    ...
    public void setFontSize(int newFontSize) {
        ...
        if (this.eNotificationRequired())
            this.eNotify(new ENotificationImpl(this, Notification.SET, FormPackage.IMAGE_PICKER_DESCRIPTION_STYLE__FONT_SIZE, oldFontSize, this.fontSize));
    }
    ...
    public void setItalic(boolean newItalic) {
        ...
        if (this.eNotificationRequired())
            this.eNotify(new ENotificationImpl(this, Notification.SET, FormPackage.IMAGE_PICKER_DESCRIPTION_STYLE__ITALIC, oldItalic, this.italic));
    }
    ...
    public void setBold(boolean newBold) {
        ...
        this.bold = newBold;
        if (this.eNotificationRequired())
            this.eNotify(new ENotificationImpl(this, Notification.SET, FormPackage.IMAGE_PICKER_DESCRIPTION_STYLE__BOLD, oldBold, this.bold));
    }
    ...
    public void setUnderline(boolean newUnderline) {
        ...
        if (this.eNotificationRequired())
            this.eNotify(new ENotificationImpl(this, Notification.SET, FormPackage.IMAGE_PICKER_DESCRIPTION_STYLE__UNDERLINE, oldUnderline, this.underline));
    }
    ...
    public void setStrikeThrough(boolean newStrikeThrough) {
        ...
        if (this.eNotificationRequired())
            this.eNotify(new ENotificationImpl(this, Notification.SET, FormPackage.IMAGE_PICKER_DESCRIPTION_STYLE__STRIKE_THROUGH, oldStrikeThrough, this.strikeThrough));
    }
    ...
    public UserColor getColor() {
        if (this.color != null && this.color.eIsProxy()) {
            ...
            if (this.color != oldColor) {
                if (this.eNotificationRequired())
                    this.eNotify(new ENotificationImpl(this, Notification.RESOLVE, FormPackage.IMAGE_PICKER_DESCRIPTION_STYLE__COLOR, oldColor, this.color));
            }
        }
        return this.color;
    }
    ...
    public void setColor(UserColor newColor) {
        ...
        this.color = newColor;
        if (this.eNotificationRequired())
            this.eNotify(new ENotificationImpl(this, Notification.SET, FormPackage.IMAGE_PICKER_DESCRIPTION_STYLE__COLOR, oldColor, this.color));
    }
    ...
    public Object eGet(int featureID, boolean resolve, boolean coreType) {
        switch (featureID) {
            case FormPackage.IMAGE_PICKER_DESCRIPTION_STYLE__FONT_SIZE:
                return this.getFontSize();
            case FormPackage.IMAGE_PICKER_DESCRIPTION_STYLE__ITALIC:
                return this.isItalic();
            case FormPackage.IMAGE_PICKER_DESCRIPTION_STYLE__BOLD:
                return this.isBold();
            case FormPackage.IMAGE_PICKER_DESCRIPTION_STYLE__UNDERLINE:
                return this.isUnderline();
            case FormPackage.IMAGE_PICKER_DESCRIPTION_STYLE__STRIKE_THROUGH:
        ...
        if (baseClass == LabelStyle.class) {
            switch (baseFeatureID) {
                case ViewPackage.LABEL_STYLE__FONT_SIZE:
                    return FormPackage.IMAGE_PICKER_DESCRIPTION_STYLE__FONT_SIZE;
                case ViewPackage.LABEL_STYLE__ITALIC:
                    return FormPackage.IMAGE_PICKER_DESCRIPTION_STYLE__ITALIC;
                case ViewPackage.LABEL_STYLE__BOLD:
                    return FormPackage.IMAGE_PICKER_DESCRIPTION_STYLE__BOLD;
                case ViewPackage.LABEL_STYLE__UNDERLINE:
                    return FormPackage.IMAGE_PICKER_DESCRIPTION_STYLE__UNDERLINE;
                case ViewPackage.LABEL_STYLE__STRIKE_THROUGH:
                    return FormPackage.IMAGE_PICKER_DESCRIPTION_STYLE__STRIKE_THROUGH;
                default:
                    return -1;
            }
        }
...
} // ImagePickerDescriptionStyleImpl
