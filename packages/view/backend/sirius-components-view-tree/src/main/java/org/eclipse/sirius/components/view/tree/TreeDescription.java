 ...
 * Expression</em>}</li>
 * <li>{@link org.eclipse.sirius.components.view.tree.TreeDescription#getTargetObjectIdExpression <em>Target Object Id
 * Expression</em>}</li>
 ...
 * Expression</em>}</li>
 * <li>{@link org.eclipse.sirius.components.view.tree.TreeDescription#getRenameTool <em>Rename Tool</em>}</li>
 * <li>{@link org.eclipse.sirius.components.view.tree.TreeDescription#getDeleteTool <em>Delete Tool</em>}</li>
 * </ul>
 *
...
public interface TreeDescription extends RepresentationDescription {
    ...
    /**
     * Returns the value of the '<em><b>Target Object Id Expression</b></em>' attribute. <!-- begin-user-doc --> <!--
     * end-user-doc -->
     * 
     * @return the value of the '<em>Target Object Id Expression</em>' attribute.
     * @see #setTargetObjectIdExpression(String)
     * @see org.eclipse.sirius.components.view.tree.TreePackage#getTreeDescription_TargetObjectIdExpression()
     * @model dataType="org.eclipse.sirius.components.view.InterpretedExpression"
     * @generated
     */
    String getTargetObjectIdExpression();

    /**
     * Sets the value of the '{@link org.eclipse.sirius.components.view.tree.TreeDescription#getTargetObjectIdExpression
     * <em>Target Object Id Expression</em>}' attribute. <!-- begin-user-doc --> <!-- end-user-doc -->
     * 
     * @param value
     *            the new value of the '<em>Target Object Id Expression</em>' attribute.
     * @see #getTargetObjectIdExpression()
     * @generated
     */
    void setTargetObjectIdExpression(String value);
    ...
    /**
     * Returns the value of the '<em><b>Rename Tool</b></em>' reference. <!-- begin-user-doc --> <!-- end-user-doc -->
     * 
     * @return the value of the '<em>Rename Tool</em>' reference.
     * @see #setRenameTool(RenameTool)
     * @see org.eclipse.sirius.components.view.tree.TreePackage#getTreeDescription_RenameTool()
     * @model
     * @generated
     */
    RenameTool getRenameTool();

    /**
     * Sets the value of the '{@link org.eclipse.sirius.components.view.tree.TreeDescription#getRenameTool <em>Rename
     * Tool</em>}' reference. <!-- begin-user-doc --> <!-- end-user-doc -->
     * 
     * @param value
     *            the new value of the '<em>Rename Tool</em>' reference.
     * @see #getRenameTool()
     * @generated
     */
    void setRenameTool(RenameTool value);

    /**
     * Returns the value of the '<em><b>Delete Tool</b></em>' reference. <!-- begin-user-doc --> <!-- end-user-doc -->
     * 
     * @return the value of the '<em>Delete Tool</em>' reference.
     * @see #setDeleteTool(DeleteTool)
     * @see org.eclipse.sirius.components.view.tree.TreePackage#getTreeDescription_DeleteTool()
     * @model
     * @generated
     */
    ...
    /**
     * Sets the value of the '{@link org.eclipse.sirius.components.view.tree.TreeDescription#getDeleteTool <em>Delete
     * Tool</em>}' reference. <!-- begin-user-doc --> <!-- end-user-doc -->
     * 
     * @param value
     *            the new value of the '<em>Delete Tool</em>' reference.
     * @see #getDeleteTool()
     * @generated
     */
