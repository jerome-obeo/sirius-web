...
public interface TreeFactory extends EFactory {
    ...
    /**
     * Returns a new object of class '<em>Tool</em>'. <!-- begin-user-doc --> <!-- end-user-doc -->
     * 
     * @return a new object of class '<em>Tool</em>'.
     * @generated
     */
    TreeTool createTreeTool();

    /**
     * Returns a new object of class '<em>Rename Tool</em>'. <!-- begin-user-doc --> <!-- end-user-doc -->
     * 
     * @return a new object of class '<em>Rename Tool</em>'.
     * @generated
     */
    RenameTool createRenameTool();
