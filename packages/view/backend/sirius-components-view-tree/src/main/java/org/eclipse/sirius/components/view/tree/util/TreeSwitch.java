...
public class TreeSwitch<T> extends Switch<T> {
    ...
    protected T doSwitch(int classifierID, EObject theEObject) {
        switch (classifierID) {
            ...
            case TreePackage.TREE_TOOL: {
                TreeTool treeTool = (TreeTool) theEObject;
                T result = caseTreeTool(treeTool);
                if (result == null)
                    result = defaultCase(theEObject);
                return result;
            }
            case TreePackage.RENAME_TOOL: {
                RenameTool renameTool = (RenameTool) theEObject;
                T result = caseRenameTool(renameTool);
                if (result == null)
                    result = caseTreeTool(renameTool);
                if (result == null)
                    result = defaultCase(theEObject);
                return result;
            }
            case TreePackage.DELETE_TOOL: {
                ...
                if (result == null)
                    result = caseTreeTool(deleteTool);
                if (result == null)
                    result = defaultCase(theEObject);
                return result;
            }
     ...
     * @generated
     */
    public T caseTreeTool(TreeTool object) {
        return null;
    }

    /**
     * Returns the result of interpreting the object as an instance of '<em>Rename Tool</em>'. <!-- begin-user-doc -->
     * This implementation returns null; returning a non-null result will terminate the switch. <!-- end-user-doc -->
     * 
     * @param object
     *            the target of the switch.
     * @return the result of interpreting the object as an instance of '<em>Rename Tool</em>'.
     * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
     * @generated
     */
    public T caseRenameTool(RenameTool object) {
        return null;
    }
