...
public class TreeAdapterFactory extends AdapterFactoryImpl {
    ...
    protected TreeSwitch<Adapter> modelSwitch = new TreeSwitch<Adapter>() {
        ...
        @Override
        public Adapter caseTreeTool(TreeTool object) {
            return createTreeToolAdapter();
        }

        @Override
        public Adapter caseRenameTool(RenameTool object) {
            return createRenameToolAdapter();
        }
    ...
    /**
     * Creates a new adapter for an object of class '{@link org.eclipse.sirius.components.view.tree.TreeTool
     ...
     * @generated
     */
    public Adapter createTreeToolAdapter() {
        return null;
    }

    /**
     * Creates a new adapter for an object of class '{@link org.eclipse.sirius.components.view.tree.RenameTool
     * <em>Rename Tool</em>}'. <!-- begin-user-doc --> This default implementation returns null so that we can easily
     * ignore cases; it's useful to ignore a case when inheritance will catch all the cases anyway. <!-- end-user-doc
     * -->
     * 
     * @return the new adapter.
     ...
     * @generated
     */
    public Adapter createRenameToolAdapter() {
        return null;
    }

    /**
     * Creates a new adapter for an object of class '{@link org.eclipse.sirius.components.view.tree.DeleteTool
