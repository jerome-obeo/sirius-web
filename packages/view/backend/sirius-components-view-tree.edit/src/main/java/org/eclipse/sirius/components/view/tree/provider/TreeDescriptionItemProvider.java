...
public class TreeDescriptionItemProvider extends RepresentationDescriptionItemProvider {
    ...
    public List<IItemPropertyDescriptor> getPropertyDescriptors(Object object) {
        if (itemPropertyDescriptors == null) {
            ...
            addTargetObjectIdExpressionPropertyDescriptor(object);
            ...
            addRenameToolPropertyDescriptor(object);
            addDeleteToolPropertyDescriptor(object);
        }
    ...
    /**
     * This adds a property descriptor for the Target Object Id Expression feature. <!-- begin-user-doc --> <!--
     * end-user-doc -->
     * 
     * @generated
     */
    protected void addTargetObjectIdExpressionPropertyDescriptor(Object object) {
        itemPropertyDescriptors.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(), getResourceLocator(),
                getString("_UI_TreeDescription_targetObjectIdExpression_feature"),
                getString("_UI_PropertyDescriptor_description", "_UI_TreeDescription_targetObjectIdExpression_feature", "_UI_TreeDescription_type"),
                TreePackage.Literals.TREE_DESCRIPTION__TARGET_OBJECT_ID_EXPRESSION, true, false, false, ItemPropertyDescriptor.GENERIC_VALUE_IMAGE, null, null));
    }
    ...
    /**
     * This adds a property descriptor for the Rename Tool feature. <!-- begin-user-doc --> <!-- end-user-doc -->
     * 
     * @generated
     */
    protected void addRenameToolPropertyDescriptor(Object object) {
        itemPropertyDescriptors.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(), getResourceLocator(),
                getString("_UI_TreeDescription_renameTool_feature"), getString("_UI_PropertyDescriptor_description", "_UI_TreeDescription_renameTool_feature", "_UI_TreeDescription_type"),
                TreePackage.Literals.TREE_DESCRIPTION__RENAME_TOOL, true, false, true, null, null, null));
    }

    /**
     * This adds a property descriptor for the Delete Tool feature. <!-- begin-user-doc --> <!-- end-user-doc -->
     * 
     * @generated
     */
    protected void addDeleteToolPropertyDescriptor(Object object) {
        itemPropertyDescriptors.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(), getResourceLocator(),
                getString("_UI_TreeDescription_deleteTool_feature"), getString("_UI_PropertyDescriptor_description", "_UI_TreeDescription_deleteTool_feature", "_UI_TreeDescription_type"),
                TreePackage.Literals.TREE_DESCRIPTION__DELETE_TOOL, true, false, true, null, null, null));
    }
