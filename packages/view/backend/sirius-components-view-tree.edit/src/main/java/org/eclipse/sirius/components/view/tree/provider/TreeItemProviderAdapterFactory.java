...
public class TreeItemProviderAdapterFactory extends TreeAdapterFactory implements ComposeableAdapterFactory, IChangeNotifier, IDisposable, IChildCreationExtender {
    ...
    /**
     * This keeps track of the one adapter used for all {@link org.eclipse.sirius.components.view.tree.TreeTool}
     * instances. <!-- begin-user-doc --> <!-- end-user-doc -->
     * 
     * @generated
     */
    protected TreeToolItemProvider treeToolItemProvider;

    /**
     * This creates an adapter for a {@link org.eclipse.sirius.components.view.tree.TreeTool}. <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     * 
     * @generated
     */
    ...
    public Adapter createTreeToolAdapter() {
        if (treeToolItemProvider == null) {
            treeToolItemProvider = new TreeToolItemProvider(this);
        }

        return treeToolItemProvider;
    }

    /**
     * This keeps track of the one adapter used for all {@link org.eclipse.sirius.components.view.tree.RenameTool}
     * instances. <!-- begin-user-doc --> <!-- end-user-doc -->
     * 
     * @generated
     */
    protected RenameToolItemProvider renameToolItemProvider;

    /**
     * This creates an adapter for a {@link org.eclipse.sirius.components.view.tree.RenameTool}. <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     * 
     * @generated
     */
    ...
    public Adapter createRenameToolAdapter() {
        if (renameToolItemProvider == null) {
            renameToolItemProvider = new RenameToolItemProvider(this);
        }

        return renameToolItemProvider;
    }

    /**
     * This keeps track of the one adapter used for all {@link org.eclipse.sirius.components.view.tree.DeleteTool}
     * instances. <!-- begin-user-doc --> <!-- end-user-doc -->
     * 
     * @generated
     */
    ...
    /**
     * This creates an adapter for a {@link org.eclipse.sirius.components.view.tree.DeleteTool}. <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     * 
     * @generated
     */
    ...
    public void dispose() {
        ...
        if (treeToolItemProvider != null)
            treeToolItemProvider.dispose();
        if (renameToolItemProvider != null)
            renameToolItemProvider.dispose();
        if (deleteToolItemProvider != null)
            deleteToolItemProvider.dispose();
    }
    ...
    public static class ViewChildCreationExtender implements IChildCreationExtender {
        ...
        protected static class CreationSwitch extends ViewSwitch<Object> {
            ...
            public Object caseView(View object) {
                newChildDescriptors.add(createChildParameter(ViewPackage.Literals.VIEW__DESCRIPTIONS, TreeFactory.eINSTANCE.createTreeDescription()));
